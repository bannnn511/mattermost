...
WebUI.click(findTestObject('Object Repository/GetTeamInviteLink/Page_Town Square - asdasdas Mattermost/svg'))

WebUI.click(findTestObject('Object Repository/GetTeamInviteLink/Page_Town Square - asdasdas Mattermost/button_Get Team Invite Link'))

WebUI.click(findTestObject('Object Repository/GetTeamInviteLink/Page_Town Square - asdasdas Mattermost/span_Copy Link'))

WebUI.click(findTestObject('Object Repository/GetTeamInviteLink/Page_Town Square - asdasdas Mattermost/span_Close'))
